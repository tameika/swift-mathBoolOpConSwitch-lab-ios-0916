    ...
    override func spec() {
        ...
        describe("averageIsAbove75(_:b:c:)") {
            it("Takes three numbers and, if their average is over 75, returns true, otherwise returns false") {
                ...
                expect( testVC.averageIsAbove75( 76.0, grade2: 75.0, grade3: 71.9 )).to(equal(false))    // NOTE we might want to get specific about the precision & rounding they should use (eg. is 75.4 > 75?  75.4 is *definitely* greater than 75.0)
                
                expect( testVC.averageIsAbove75( 75.0, grade2: 75.0, grade3: 75.0 )).to(equal(false))    // must be *OVER* 75
                
                expect( testVC.averageIsAbove75( 75.1, grade2: 75.0, grade3: 75.0 )).to(equal(true))   // they should be using Doubles, so this is *just* over 75
                
                expect( testVC.averageIsAbove75( 80.0, grade2: 80.0, grade3: 80.0 )).to(equal(true))
            }
        }
